...
async function getWeather(city){
    var response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=8662579a36734763b33173833242602&q=${city}&days=3`);
...
async function getWeatherByCoords(latitude,longitude){
     var response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=8662579a36734763b33173833242602&q=${latitude},${longitude}&days=3`);
    var data = await response.json();
    weather = data ;
    console.log(weather);
    display();
